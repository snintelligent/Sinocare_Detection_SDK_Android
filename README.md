...
参数名称|备注| 
---|--- |
code|  02 错误值, 04 当前测试值, 05 历史数据值, 20 历史数据序号, B7 测量过程值, 0E 历史数据补发| 
data|  返回内容| 
msg| 描述| 
 ...
 * 清除设备历史数据
 * @param snDevice
 * @param SampleType   SampleType.XXX   要清除的样本类型 （不传入则清除所有）
 */
...
# 5 设备信息说明 ![详细设备请见/app/assets/deviceInfo.json文件](./app/assets/deviceInfo.json)
