...
### (注意)此版本为新版本SDK 2.x.x, 需要旧版SDK请点击[(gitee)旧版SDK 1.2.x](https://gitee.com/sinocare-iot/Sinocare_Detection_SDK_Android/tree/sinocare_ble_1.2.x/)
### (注意)此版本为新版本SDK 2.x.x, 需要旧版SDK请点击[(github)旧版SDK 1.2.x](https://github.com/snintelligent/Sinocare_Detection_SDK_Android/tree/sinocare_ble_1.2.x)
...
```powershell
  implementation 'com.sinocare.android_lib:multicriteriasdk:2.0.0_lite'
```
